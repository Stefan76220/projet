...
var to = class {
	...
	submitHistory(e) {
		let t = this.position.getPositionContext(), n = Ln(this.elementList), r = Ln(this.header.getElementList()), i = Ln(this.footer.getElementList()), a = k(this.range.getRange()), o = this.pageNo, s = k(t), c = this.zone.getZone();
		this.historyManager.execute(() => {
			this.zone.setZone(c), this.setPageNo(o), this.position.setPositionContext(k(s)), this.header.setElementList(k(r)), this.footer.setElementList(k(i)), this.elementList = k(n), this.range.replaceRange(k(a)), this.render({
				curIndex: e,
				isSubmitHistory: !1,
				isSourceHistory: !0
			});

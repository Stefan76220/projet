...
class TomeLineaV3(tk.Tk):
    ...
    def _build_structure_tab(self, parent):
        """Structure V10 : C = catalogue/règles ; bandeau d’actions dans B."""
        ...
        # --------------------------------------------------------------
        # V10 — Les commandes d’organisation quittent C.
        # Elles vivent désormais dans le bandeau Structure de B.
        # C reste le catalogue de briques et le lieu des règles générales.
        # --------------------------------------------------------------
        ...
        palette_head.grid(row=0, column=0, sticky="ew", pady=(0, 3))
        ...
        palette_body.grid(row=1, column=0, sticky="nsew")
        ...
        def create_custom_type():
            ...
            def confirm_new_type():
                ...
                self.after_idle(lambda: select_family("Pages")); return False
        ...
        def select_family(name):
            ...
            if name=="Pages":
                ...
                palette_hint_var.set("Choisissez une brique, puis cliquez dans B. Nouveau type ajoute sa brique ici.")
            elif name=="Règles":
                build_rules()
                palette_hint_var.set("Même outil : règle générale du type + exception sur la page sélectionnée.")

        for family in ("Pages","Règles"):
            button=tk.Button(

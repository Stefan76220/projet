...
def create_book_from_proposal(
    ...
    *,
    ...
    for proposed in proposal.pages:
        ...
        # Mémorise le rôle physique des quatre faces de couverture dès la
        # création du Livre. La protection reste ainsi attachée à la page
        # même si son libellé/type est ensuite renommé par l'utilisateur.
        from src.v4.structure_covers import mark_cover_face
        mark_cover_face(page)
    ...
    # Les 2e et 3e de couverture sont des faces physiques qui existent
    # toujours, même si l'auteur n'a fourni aucun contenu pour elles.
    from src.v4.structure_covers import ensure_inside_cover_faces

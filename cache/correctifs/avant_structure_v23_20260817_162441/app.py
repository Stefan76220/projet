...
class TomeLineaV3(tk.Tk):
    ...
    def _build_structure_tab(self, parent):
        ...
        # V22_NOUVEAU_TYPE_CENTRE :
        # la commande Nouveau type quitte le coin droit et prend une place
        # centrale dédiée sous le catalogue.
        ...
        # V22_NOUVEAU_TYPE_CENTRE :
        # on réutilise exactement l'espace libéré par "Pages auto".
        new_type_line = tk.Frame(atelier, bg=WORK_BG, height=26)
        new_type_line.grid(row=2, column=0, sticky="ew", pady=(5, 0))
        new_type_line.grid_propagate(False)

        new_type_center = tk.Frame(new_type_line, bg=WORK_BG)
        new_type_center.place(relx=0.5, rely=0.5, anchor="center")
        command_chip(
            new_type_center,
            "+ Nouveau type",
            create_custom_type,

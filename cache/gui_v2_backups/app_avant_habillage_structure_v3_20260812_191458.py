...
class PageMaitreV2(tk.Tk):
    ...
    def _build_maquettage(self, parent: tk.Frame) -> None:
        ...
        def render(_event=None):
            ...
            # La structure métier et les outils restent inchangés.
            ...
            for index, group in enumerate(structure_model):
                ...
                # Sélection sobre, comme sur la référence validée.
                if is_selected:
                    rounded(
                        cx - 43,
                        cy - 43,
                ...
                # Petite ombre sous le médaillon.
                canvas.create_oval(
                    cx - 24 + 1,
                    cy - 24 + 3,
                    cx + 24 + 1,
                ...
                # Médaillon extérieur + anneau coloré intérieur.
                canvas.create_oval(
                    cx - 24,
                    cy - 24,
                    cx + 24,
                ...
                # Icône selon la position dans le squelette.
                if index == 0:
                    # Début : petit drapeau.
                    pole_x = cx - 8
                    canvas.create_line(
                    ...
                    canvas.create_polygon(
                        ...
                        pole_x,
                        cy - 2,
                        fill=self._mix(color, "#FFFFFF", 0.16),
                        outline=color,
                        width=1,
                        tags="maquettage_ui",
                    )
                    ...
                    # Fin : drapeau d'arrivée simplifié.
                    pole_x = cx - 8
                    canvas.create_line(
                        pole_x,
                        cy - 11,
                    ...
                    # Parties : livre ouvert, volontairement simple.
                    book_color = self._mix(
                        color,
                        theme.INK,
                        0.28,
                    )

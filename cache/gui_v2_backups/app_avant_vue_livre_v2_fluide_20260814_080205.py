...
class PageMaitreV2(tk.Tk):
    ...
    def _tomelinea_open_book_views(self, initial_tab="global"):
        ...
        def render_book(_event=None):
            ...
            # Fond contrôle / table de montage autour du livre.
            margin = 34
            ...
            # Numéros seuls : vue de contrôle, pas de propriétés.
            if left_page is not None:
                book_canvas.create_text(
                    left_x + page_w / 2,
                    y1 + page_h + 28,
                    text=f'p. {left_page["global"]}',
                    fill="#70777C",
                    font=("Segoe UI", 8),
                    anchor="center",
                )
        ...
        def animate_window_to(target_size):
            ...
            def frame(step):
                ...
                t = step / steps
                # Courbe douce, évite le côté "fenêtre qui saute".
                eased = t * t * (3.0 - 2.0 * t)

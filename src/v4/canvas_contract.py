    ...
    *,
    ...
    return {
        ...
        "character_format": {
            ...
            "strikeout": bool(effective.get("strike") or effective.get("double_strike")),
            "double_strike": effective.get("double_strike"),
            "highlight": effective.get("highlight"),
            "vertical_align": effective.get("vertical_align"),
            "caps": effective.get("caps"),
            "small_caps": effective.get("small_caps"),
            "vanish": effective.get("vanish"),
            "character_spacing_pt": effective.get("spacing_pt"),
            "position_pt": effective.get("position_pt"),
            "color": color_value,
...
def build_canvas_contract(phase2_model: dict[str, Any]) -> CanvasContractResult:
    ...
    contract = {
        ...
        "fonts": {
            "requirements": deepcopy(phase2_model.get("fonts", {}).get("requirements", [])),
            "resolution": deepcopy(phase2_model.get("fonts", {}).get("resolution", [])),
        },
        "layout_policy": {

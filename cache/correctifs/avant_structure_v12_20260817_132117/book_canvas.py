...
class BookCanvas(tk.Frame):
    ...
    def _structure_bar_button(self, parent, text, command, *, danger=False):
        ...
        hover = "#3A5559"
        pressed = "#243438"
        edge = "#A95D50" if danger else "#5F8E8A"
        fg = "#F0D8CF" if danger else "#E9ECE8"
        label = tk.Label(
            parent, text=text, bg=base, fg=fg,
            font=(theme.FONT_UI, 7, "bold"), padx=9, pady=2,
    ...
    def _build_canvas(self):
        ...
        # Bandeau Structure V11 : fin, lisible, même identité d'atelier que C.
        self.structure_command_bar = tk.Frame(
            viewer, bg="#293A3D", height=30,
        ...
        tk.Frame(self.structure_command_bar, bg="#C2A36A", width=2).pack(side="left", fill="y")
        tk.Label(
            self.structure_command_bar, text="◆", bg="#293A3D", fg="#74B6AA",
            font=(theme.FONT_UI, 7, "bold"),
        ).pack(side="left", padx=(7, 6))

        self.structure_new_part_btn = self._structure_bar_button(
            self.structure_command_bar, "+ Partie", self._structure_new_part_command
        )
        self.structure_new_part_btn.pack(side="left", padx=(0, 5), pady=3)
        ...
        self.structure_duplicate_btn.pack(side="left", padx=(0, 5), pady=3)
        ...
        self.structure_delete_btn.pack(side="left", padx=(0, 5), pady=3)

        tk.Label(
            self.structure_command_bar,
            text="sélection → action → cible → confirmer",
            bg="#293A3D", fg="#8FA09F",

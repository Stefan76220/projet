...
ACCUEIL_BG = (
    ...
    / "interface"
    / "backgrounds"
    / "editorial_bg_sombre_tomelinea.png"
)
...
class PageMaitreV2(tk.Tk):
    ...
    # CHARTE_TOMELINEA_SOMBRE_GLOBALE_V3
    # CHARTE_TOMELINEA_SOMBRE_ADOUCIE_V1
    # CHARTE_TOMELINEA_FOND_COULEUR_V1
    # CHARTE_TOMELINEA_FOND_ASSOMBRI_V1
    ...
    def _make_nav_icon(self, parent, *, key: str, label: str, accent: str):
        frame = tk.Frame(parent, bg=theme.PANEL, padx=4, pady=2, cursor="hand2")

        image_label = tk.Label(frame, bg=theme.PANEL, bd=0, cursor="hand2")
        image_label.pack(pady=(1, 0))

        text_label = tk.Label(
            frame, text=label, bg=theme.PANEL, fg=theme.INK,
            font=("Segoe UI", 8), cursor="hand2"
        )
        text_label.pack()

        dot = tk.Label(
            frame, text="•", bg=theme.PANEL, fg=accent,
    ...
    def _make_side_icon(
        ...
        image_label = tk.Label(frame, bg=theme.PANEL, bd=0)
        image_label.pack()

        text_label = tk.Label(
            frame, text=label, bg=theme.PANEL,
    ...
    def _draw_nav_canvas_item(
        ...
        *,
        ...
        if state == "actif":
            halo_outer = self._mix(accent, theme.PANEL, 0.72)
            halo_inner = self._mix(accent, theme.PANEL, 0.62)
            ...
            canvas.create_oval(
                ...
                x + 27, y + 10,
                fill=halo_inner,
                outline=self._mix(accent, theme.PANEL, 0.38),
                width=1,
                tags=(tag, "nav_item"),
            )
    ...
    def _accueil_project_confirmation_window(
        ...
        *,
        ...
        icon_box = tk.Label(visual, bg=theme.PANEL_ALT, text="")
        if photo is not None:
        ...
        text_zone = tk.Frame(content, bg=theme.PANEL)
    ...
    def _open_accueil_open_project_window(self):
        ...
        actions = tk.Frame(body, bg=theme.PANEL, height=52)
        ...
        left = tk.Frame(content, bg=theme.PANEL)
        ...
        path_row = tk.Frame(left, bg=theme.PANEL)
        ...
        icon_label = tk.Label(right, bg=theme.PANEL_ALT, text="")
    ...
    def _open_accueil_resume_project_window(self):
        ...
        icon_label = tk.Label(left, bg=theme.PANEL_ALT, text="")
        if photo is not None:
        ...
        right = tk.Frame(content, bg=theme.PANEL)
        ...
        for label, value in (
            ...
            line = tk.Frame(project, bg=theme.PANEL_ALT)
    ...
    def _build_accueil(self, parent: tk.Frame) -> None:
        ...
        def cut_panel(
            x1, y1, x2, y2,
            *, fill=theme.PANEL, outline="#D9D5CF", accent=None,
        ...
        def render(_event=None):
            ...
            if self._accueil_bg_source is not None:
                try:
                    ...
                    canvas.configure(bg=theme.WINDOW)
    ...
    def _shortcut_box(
        ...
        box = tk.Frame(
            parent,
            bg=self._mix(color, theme.PANEL, 0.70),
            highlightthickness=1,
    ...
    def _screen_header(
        ...
        line = tk.Frame(block, bg=theme.BORDER, height=1)
        line.place(x=330, y=28, relwidth=1.0, width=-370)
        station = tk.Frame(block, bg=accent, width=6, height=6)
        station.place(relx=1.0, x=-36, y=25, anchor="n")
    ...
    def _card(
        ...
        *,
        ...
        spiral = tk.Canvas(card, bg=theme.PANEL, width=12, highlightthickness=0, bd=0)
        spiral.place(x=1, y=7, relheight=1.0, height=-14)
        def _draw_spiral(_event=None):
            spiral.delete("all")
            sh = max(40, spiral.winfo_height())
            y = 10
            while y < sh - 8:
                spiral.create_arc(-3, y-5, 13, y+7, start=300, extent=245,
                                  style="arc", outline=theme.BORDER, width=1)
                y += 18
        spiral.bind("<Configure>", _draw_spiral)
        title_line = tk.Frame(card, bg=theme.BORDER, height=1)
        title_line.place(x=18, y=41, relwidth=1.0, width=-34)
        station = tk.Frame(card, bg=accent, width=5, height=5)
        station.place(relx=1.0, x=-18, y=39, anchor="n")
        ...
        def render(_event=None):
            ...
            if ACCUEIL_BG.exists():
                try:
                    ...
                    self._centre_dark_bg_photo = ImageTk.PhotoImage(source)
                    canvas.create_image(0, 0, image=self._centre_dark_bg_photo, anchor="nw")
                except Exception:
                    canvas.create_rectangle(0, 0, w, h, fill=theme.WINDOW, outline="")
            else:
                canvas.create_rectangle(0, 0, w, h, fill=theme.WINDOW, outline="")
        ...
        def _make_button(
            ...
            *,
            ...
            def draw():
                ...
                if primary:
                    if not active:
                        face, outline, fg = "#3C4047", "#666B74", "#9AA0A8"
                        shadow, shadow_y = "#24272D", 1
                    elif pressed:
                        face, outline, fg = "#343840", "#6B707A", "#F2F3F5"
                        shadow, shadow_y = "#21242A", 1
                    elif hover:
                        face, outline, fg = "#3A3E46", "#6C717B", "#F2F3F5"
                        shadow, shadow_y = "#262930", 2
                    else:
                        face, outline, fg = "#383C44", "#666B74", "#F2F3F5"
                        shadow, shadow_y = "#25282E", 2
                else:
                    if not active:
                        face, outline, fg = "#3C4047", "#666B74", "#9AA0A8"
                        shadow, shadow_y = "#24272D", 1
    ...
    def _build_maquettage(self, parent: tk.Frame) -> None:
        ...
        def render(_event=None):
            ...
            if getattr(self, "_maquettage_smoke_v3_size", None) != bg_size:
                ...
                smoke_bg = Image.new("RGBA", bg_size, theme.WINDOW)

    ...
    def _build_accueil(self, parent: tk.Frame) -> None:
        ...
        def home_command_button(
            ...
            *,
            ...
            """Bouton de commande : verre dépoli légèrement rugueux, sans reflet haut."""
        ...
        def home_choice_panel(
            ...
            *,
            ...
            """Carte de choix : verre dépoli un peu rugueux, sans reflet haut."""
            if not hasattr(self, "_home_interaction_state"):
                self._home_interaction_state = {}
        ...
        def home_chip(canvas, *, x, y, text, bg, fg, tag):
            """Capsule informative : verre dépoli rugueux, sans reflet haut."""
        ...
        def home_shortcut_button(
            ...
            *,
            ...
            """Raccourci : verre dépoli un peu rugueux, sans reflet haut."""
            if not hasattr(self, "_home_interaction_state"):
                self._home_interaction_state = {}

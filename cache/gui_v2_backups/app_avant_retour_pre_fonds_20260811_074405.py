...
class PageMaitreV2(tk.Tk):
    ...
    def _build_accueil(self, parent: tk.Frame) -> None:
        ...
        open_body.pack(padx=40, pady=(22, 20))
    ...
    def _home_card(
        ...
        *,
        ...
        """Grande zone arrondie avec texte directement posé sur le décor."""
        ...
        background = tk.Canvas(
            card,
            bg=self._mix(accent, "#FFFFFF", 0.92),
            bd=0,
            highlightthickness=0,
        )
        ...
        def redraw(_event=None):
            ...
            background.create_polygon(
                ...
                smooth=True,
                splinesteps=32,
                fill=self._mix(accent, "#FFFFFF", 0.90),
                outline="",
                width=0,
            )

            if card._home_bg_pil is not None:
                try:
                    img = card._home_bg_pil.resize(
                    ...
                    card._home_bg_photo = ImageTk.PhotoImage(img)
        ...
        # Réserve seulement la hauteur nécessaire ; 1 px de large,
        # donc aucun bandeau opaque ne masque le décor.
        spacer = tk.Frame(
            card,
            bg=parent.cget("bg"),
            width=1,

...
class BookCanvas(tk.Frame):
    ...
    def _structure_action_button(self, mode: str):
        ...
        self.after_idle(self._structure_recenter_selection)
    ...
    def _build_canvas(self):
        ...
        # Bandeau Structure : seulement la longueur de ses commandes, centré dans B.
        # La ligne B garde exactement la même place ; seul le fond du ruban rétrécit.
    ...
    def _structure_insert_group_at_position(self, target: int) -> str | None:
        ...
        self._save_order()
        self.render()
        self.after_idle(self.center_selected_group)

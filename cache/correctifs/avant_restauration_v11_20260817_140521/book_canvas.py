...
class BookCanvas(tk.Frame):
    ...
    def _build_canvas(self):
        ...
        # Structure V14 RESET : aucun bandeau d'outil dans B.
        # Les anciennes commandes restent disponibles dans le code, mais aucun
        # composant visuel n'est créé tant que le nouveau design n'est pas validé.
        self.structure_command_bar_host = None
        self.structure_command_bar = None
        self.structure_new_part_btn = None
        self.structure_rename_btn = None
        self.structure_duplicate_btn = None
        self.structure_delete_btn = None

...
class PMCommandButton(tk.Canvas):
    ...
    SIZES = {
        "sm": {"height": 34, "font": 9, "shadow": 2, "radius": 11},
        "md": {"height": 42, "font": 10, "shadow": 3, "radius": 13},
        "lg": {"height": 50, "font": 11, "shadow": 4, "radius": 15},
    }
    ...
    def _palette(self) -> dict[str, str]:
        ...
        if self._state == "hover":
            ...
            shadow1 = self._mix(base, "#667A62", 0.25)
            shadow2 = self._mix(base, "#7D9078", 0.38)
        elif self._state == "pressed":
            face = self._mix(base, "#FFFFFF", 0.64)
            shadow1 = self._mix(base, "#61715D", 0.25)
            shadow2 = self._mix(base, "#768871", 0.34)
        else:
            face = self._mix(base, "#FFFFFF", 0.82)
            shadow1 = self._mix(base, "#667A62", 0.28)
            shadow2 = self._mix(base, "#7D9078", 0.42)
    ...
    def _draw(self) -> None:
        ...
        press_offset = 1 if self._state == "pressed" else 0
        lift = 1 if self._state == "hover" else 0

        # Relief doux : deux niveaux d'ombre discrets, puis la face.
        self._rounded_rect(
            4,

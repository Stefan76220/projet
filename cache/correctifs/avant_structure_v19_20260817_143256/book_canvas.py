...
class BookCanvas(tk.Frame):
    ...
    def _build_canvas(self):
        ...
        tk.Frame(self.structure_command_bar, bg="#C39A4A", width=2).pack(side="left", fill="y")
        tk.Label(
            self.structure_command_bar, text="◆", bg="#102633", fg="#C39A4A",

...
class PageMaitreV2(tk.Tk):
    ...
    def _home_card(
        ...
        *,
        ...
        """Grande zone arrondie de l'accueil, avec décor de fond optionnel."""
        ...
        def _rounded_points(width: int, height: int, r: int):
            return [
                r, 1,
                width - r, 1,
                width - 1, 1,
        ...
        def redraw(_event=None):
            ...
            background.create_polygon(
                _rounded_points(width, height, radius),
                smooth=True,
                splinesteps=32,
                fill=bg,
                outline="",
        ...
        background.bind("<Configure>", redraw, add="+")

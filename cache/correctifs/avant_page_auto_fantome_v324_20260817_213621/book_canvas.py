...
class BookCanvas(tk.Frame):
    ...
    def _draw_page_auto_rule_markers(
        ...
        for position in ("before", "after"):
            ...
            # V32.3 : le fantôme doit indiquer immédiatement le côté visé.
            # Il ne reste qu'une petite accroche sous la page principale :
            # presque toute la page fantôme dépasse à gauche (Avant)
            # ou à droite (Après).
            overlap = ghost_w * 0.08
            if position == "before":

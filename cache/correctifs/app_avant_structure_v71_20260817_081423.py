...
class TomeLineaV3(tk.Tk):
    ...
    def _build_structure_tab(self, parent):
        ...
        def select_family(name: str):
            ...
            if name == "Pages":
                entries = []
                entries.append(lambda: make_brick(palette_body, "Page sans type", "page", {"type": "", "label": "Sans type"}, subtitle="page libre"))
                entries.append(lambda: make_brick(palette_body, "Page blanche", "page", {"type": "page_blanche", "label": "Page blanche"}, subtitle="page volontaire"))
                for type_key, label, _custom in page_types():
                    entries.append(lambda k=type_key, l=label: make_brick(palette_body, l, "page", {"type": k, "label": l}))
                ...
                for type_key, label, locked in all_type_entries():
                    entries.append(
                        lambda k=type_key, l=label, locked_=locked: make_brick(
                            palette_body, l, "page", {"type": k, "label": l},

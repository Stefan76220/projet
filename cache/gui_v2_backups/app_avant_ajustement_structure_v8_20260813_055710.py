...
class PageMaitreV2(tk.Tk):
    ...
    def _build_maquettage(self, parent: tk.Frame) -> None:
        ...
        def render(_event=None):
            ...
            # Début et Fin sont désormais pensés comme deux bornes fixes.
            # Plus tard, seules les parties intermédiaires défileront entre elles.
            node_count = len(structure_model)

            # Les deux bornes restent volontairement en retrait des bords :
            # - Début laisse respirer le titre / sous-titre.
            # - Fin ne vient pas coller au panneau Outils de structure.
            fixed_start_x = track_left + 52
            fixed_end_x = track_right - 76
            ...
            finish_icon_path = structure_icon_dir / "fin_final.png"
            book_icon_paths = [
            ...
            def structure_photo(path, max_w, max_h):
                ...
                try:
                    ...
                    # Recadrage sur les pixels réellement visibles :
                    # les deux drapeaux occupent ainsi une hauteur comparable.
            ...
            # Ligne unique, fine et neutre, entre les deux bornes fixes.
            canvas.create_line(
                fixed_start_x,
                track_y,
                fixed_end_x,
            ...
            for index, group in enumerate(structure_model):
                ...
                # Losange de station :
                # blanc par défaut, noir uniquement pour la partie active.
                ...
                if index == 0:
                    ...
                    # Taille réduite juste assez pour libérer le sous-titre.
                    icon_w, icon_h = 42, 34
                elif index == node_count - 1:
                    icon_path = finish_icon_path
                    # Même boîte que le drapeau de départ.
                    icon_w, icon_h = 42, 34
                else:
                ...
                photo = structure_photo(icon_path, icon_w, icon_h)
                if photo is not None:
                    # Toutes les icônes reposent visuellement juste au-dessus
                    # de la ligne et partagent le même niveau inférieur.
                    canvas.create_image(
                        cx,
                        track_y - 4,
                        image=photo,
                ...
                # Position courante : losange noir + soulignement noir discret.
                if is_selected:
                    canvas.create_line(
                        cx - 27,
                        track_y + 65,

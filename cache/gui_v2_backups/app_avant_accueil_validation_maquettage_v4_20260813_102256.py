...
class PageMaitreV2(tk.Tk):
    ...
    def _accueil_project_confirmation_window(
        ...
        *,
        ...
        self._accueil_center_base_window(win, 700, 500)

        body = self._accueil_base_shell(
            win,
            title=title,
            subtitle=(
                "Vérifiez le type de projet choisi avant de poursuivre. "
                "Cette étape sera enrichie lorsque les options seront définies."
            ),
            accent=accent,
        )
        ...
        tk.Label(
            body,
            text=(
                "Les paramètres précis proposés ici seront décidés plus tard. "
                "Pour l'instant cette fenêtre sert de base de confirmation."
            ),
            bg="#FFFEFC",
            fg="#737B83",
            font=("Segoe UI", 8),
        ...
        # Confirmation volontairement visuelle seulement pour le moment.
        tk.Label(
            actions,
            text="Confirmer ce choix   ›",
            bg="#173B6C",
            fg="#FFFFFF",
            font=("Segoe UI", 9, "bold"),
            padx=16,
    ...
    def _open_accueil_create_structured_window(self):
        self._accueil_project_confirmation_window(
            ...
            points=(
                ...
                "Le Maquettage servira à construire l'ordre général du livre.",
            ),
        )
    ...
    def _open_accueil_create_textual_window(self):
        self._accueil_project_confirmation_window(
            ...
            points=(
                "Le contenu sera principalement organisé en chapitres.",
                "La continuité du texte sera prioritaire dans la mise en page.",
                "Les pages particulières pourront être ajoutées autour du texte.",
            ),
        )
    ...
    def _open_accueil_create_comic_window(self):
        self._accueil_project_confirmation_window(
            ...
            points=(
                "Le livre sera organisé en planches et séquences.",
                "Les pages pourront accueillir des compositions spécifiques.",
                "Les outils dédiés aux cases et à la narration viendront plus tard.",
            ),
        )

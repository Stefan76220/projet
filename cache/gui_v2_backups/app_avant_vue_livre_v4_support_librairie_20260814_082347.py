...
class PageMaitreV2(tk.Tk):
    ...
    def _tomelinea_open_book_views(self, initial_tab="global"):
        ...
        def draw_book_background(geometry):
            ...
            # Socle du livre : conservé mais adouci pour rester dans la
            # même famille que le plateau de la Vue globale.
            cradle = mix_hex("#92877C", "#FFFFFF", 0.18)
        ...
        def draw_spread(
            ...
            *,
            ...
            if show_controls:
                # Aucune flèche : le geste sur le livre est l'interface.
                # Une seule indication, discrète et centrée.
                hint_y = h - 36
                ...
                book_canvas.create_text(
                    w / 2 - 94,
                    hint_y,
                    text="Cliquez à gauche ou à droite pour tourner la page",
                    fill="#7A7F84",
                    font=("Segoe UI", 7),
                    anchor="w",
                )
        ...
        def animate_window_to(target_size):
            ...
            # On fige le contenu lourd pendant le morphing : seuls la
            # géométrie de la fenêtre et son cadre léger sont recalculés.
            ...
            def frame(step):
                ...
                t = step / steps
                # Smoothstep quintique : départ et arrivée sans à-coup.
                eased = (
                    t * t * t
                    * (
                        t * (t * 6.0 - 15.0)
        ...
        def show_tab(key, *, animate=True):
            ...
            if key == "global":
                ...
                subtitle_label.configure(
                    text=(
                        "Feuilletez les doubles pages comme "
                        "dans le livre."
                    )
                )

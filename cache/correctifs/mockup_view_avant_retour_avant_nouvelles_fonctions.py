...
class MockupView:
    ...
    def _create_soft_background_container(self, parent):
        """Test fonctionnel : conteneur CTk stable, sans image redimensionnée."""
        return ctk.CTkFrame(
            parent,
    ...
    def _start_group_drag(self, event, group_id: str) -> None:
        ...
        # Ne modifier aucun widget CustomTkinter au démarrage du drag.
        # La modification dynamique de border_width force un recalcul/redessin
        # du groupe et de ses enfants pendant que le bouton est maintenu.
    ...
    def _continue_group_drag(self, event) -> None:
        ...
        if self._drag_group_has_moved:
            # Diagnostic ciblé : aucun widget/overlay n'est créé pendant le drag.
            # Le point de dépôt est toujours calculé au relâchement.
            pass
    ...
    def _finish_group_drag(self, event) -> None:
        ...
        # Aucun changement de bordure à restaurer : le drag ne modifie plus
        # l'apparence du widget source.
        if moved:
    ...
    def _show_group_drop_indicator(
        ...
        # L'indicateur appartient uniquement au panneau des groupes.
        # Le placer sur la racine de la vue pouvait passer devant le ruban
        # complet pendant le glisser-déposer.
        overlay = self._ribbon_groups_panel

...
class PageMaitreV2(tk.Tk):
    ...
    def _accueil_make_dialog_button(
        ...
        *,
        ...
        button = tk.Button(
            ...
            activebackground="#24558A" if primary else "#F3F4F6",
            activeforeground="#FFFFFF" if primary else "#26313A",
    ...
    def _accueil_project_confirmation_window(
        ...
        *,
        ...
        self._accueil_center_base_window(win, 880, 580)
        ...
        photo = self._accueil_get_type_icon_photo(choice_key, 170)
        icon_box = tk.Label(
            left,
            bg="#FAF8F4",
            text="",
        ...
        chip.pack(fill="x", pady=(14, 0))
        tk.Label(
            chip,
            text="Maquettage commun",
            bg="#FFFEFC",
            fg="#4D5B69",
            font=("Segoe UI", 8, "bold"),
        ).pack()

        right = tk.Frame(body=top if False else top, bg="#FFFEFC")
    ...
    def _open_accueil_open_project_window(self):
        ...
        self._prepare_accueil_dialog(win)
        self._accueil_center_base_window(win, 920, 570)

...
from src.gui_v2.tomelinea_controls import TLCommandButton, TLChoiceCard
    ...
    def _build_accueil(self, parent: tk.Frame) -> None:
        ...
        def home_command_button(
            ...
            *,
            ...
            """Commande TomeLinea : composant commun, couleur et dimensions unifiées."""
        ...
        def home_choice_panel(
            ...
            *,
            ...
            """Carte de choix TomeLinea : composant commun, distinct d'une commande."""
            if not hasattr(self, "_home_interaction_state"):
                self._home_interaction_state = {}

...
class PageMaitreV2(tk.Tk):
    ...
    def _build_accueil(self, parent: tk.Frame) -> None:
        ...
        self._project_type_card(
            ...
            color="#6AB08F",
            icon_path=(
                Path(__file__).resolve().parents[2] / "assets" / "gui_v2" / "project_type_icons_active" / "ouvrage_structure_photo.png"
            ),
        ...
        self._project_type_card(
            ...
            color="#A888D2",
            icon_path=(
                Path(__file__).resolve().parents[2] / "assets" / "gui_v2" / "project_type_icons_active" / "livre_textuel_photo.png"
            ),
        ...
        self._project_type_card(
            ...
            color="#F07D63",
            icon_path=(
                Path(__file__).resolve().parents[2] / "assets" / "gui_v2" / "project_type_icons_active" / "bande_dessinee_photo.png"
            ),

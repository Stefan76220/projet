...
class TomeLineaV3(tk.Tk):
    ...
    def _build_gabarits_tab(self, parent):
        """Gabarits : trois familles de travail ; les réglages du livre vivent dans B."""
        WORK_BG = "#102633"
        CARD_BG = "#0E202B"
        CARD_BORDER = "#385264"
        TEAL = "#78B8B1"
        ...
        # L'ordre visuel suit l'ordre réel de travail. La famille PAGE a quitté C :
        # format, marges et fond perdu sont désormais regroupés dans l'inspecteur de B.
        weights = (4, 5, 4)
        ...
        content_card, content_box = family_card(0, "1", "CONTENU", "préparer Production")
        place_card, place_box = family_card(1, "2", "PLACEMENT", "positionner et dimensionner")
        align_card, align_box = family_card(2, "3", "ALIGNEMENT", "ordonner précisément")
        ...
        content_hint.grid(row=1, column=0, columnspan=2, sticky="ew", pady=(7, 0))
        delete_zone_btn = V3Button(content_box, "Supprimer", delete_selected_zone, compact=True, state="disabled")
        delete_zone_btn.grid(row=1, column=2, sticky="e", padx=(6, 0), pady=(6, 0))
        ...
        template_row.grid(row=2, column=0, columnspan=3, sticky="ew", pady=(7, 0))
        ...
        copy_template_btn.grid(row=0, column=0, sticky="ew", padx=(0, 4))
        apply_template_btn = V3Button(template_row, "Appliquer", apply_page_template, compact=True, state="disabled")
        apply_template_btn.grid(row=0, column=1, sticky="ew", padx=(4, 0))

...
class PageMaitreV2(tk.Tk):
    ...
    def _accueil_project_confirmation_window(
        ...
        *,
        ...
        self._accueil_center_base_window(win, 730, 590)
        ...
        body = self._accueil_base_shell(
            ...
            subtitle=(
                ...
                "Il ne sera pas redemandé pendant l'avancement du livre."
            ),
            accent=accent,
        )
        ...
        route_rows = (
            ("1. Maquettage", "Commun aux trois types de projet"),
            ("2. Conception", conception_name),
            (
                "3. Suite du parcours",
                "Flux commun : Assemblage → Vérification → Finalisation",
            ),
        )
        ...
        tk.Label(
            body,
            text=(
                "Le texte et les réglages de cette fenêtre restent provisoires. "
                "Ils pourront être précisés lorsque les options de création "
                "de chaque type seront définies."
            ),
            bg="#FFFEFC",
            fg="#737B83",
            font=("Segoe UI", 8),

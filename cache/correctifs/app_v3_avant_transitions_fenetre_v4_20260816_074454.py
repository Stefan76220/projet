...
class TomeLineaV3(tk.Tk):
    ...
    def _window_minimize(self):
        """Réduction propre : aucun flash de barre de titre Windows."""
        try:
    ...
    def _window_restore_frameless(self, _event=None):
        """Restaure TomeLinea directement dans son habillage, sans flash Windows."""
    ...
    def _window_toggle_size(self):
        """Bascule entre la grande vue et une fenêtre restaurée stable."""
        ...
        if maximized:
            ...
            self._tomelinea_window_maximized = False
            if hasattr(self, "zone_a_size_button"):
                self.zone_a_size_button.configure(text="□")
        else:
            self._fit_to_windows_work_area()
            self._tomelinea_window_maximized = True
            if hasattr(self, "zone_a_size_button"):
                self.zone_a_size_button.configure(text="❐")

...
class PageMaitreV2(tk.Tk):
    ...
    def _get_notebook_spiral_photo(
        ...
        *,
        ...
        tint_alpha = alpha.point(lambda v: int(v * 0.12))
    ...
    def _draw_notebook_spiral_canvas(
        ...
        *,
        ...
        # SPIRALE_IMAGE_REALISTE_ZONES_V1
    ...
    def _attach_notebook_spiral_frame(self, frame, color: str) -> None:
        ...
        spring.place(x=0, y=7, width=18, relheight=1.0)

        def redraw(_event=None):
            spring.configure(bg=frame.cget("bg"))
            spring.delete("all")
            h = max(30, spring.winfo_height() - 16)
            photo = self._get_notebook_spiral_photo(
                h,
                color,
                opacity=0.82,
            ...
            if photo is None:
                return
            x = max(0, (spring.winfo_width() - photo.width()) // 2)
        ...
        # Canvas redéfinit tkraise() / lift() pour ses items internes.

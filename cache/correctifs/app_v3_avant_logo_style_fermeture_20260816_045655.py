...
class TomeLineaV3(tk.Tk):
    ...
    def _build_home(self):
        ...
        # --------------------------------------------------------------
        # ACCUEIL_LOGO_NOUVEAU_ZIP_V3_V2
        ...
        icon_photo = self._home_brand_icon_photo(92)
        title_left = 0
        ...
        title_row = tk.Frame(brand_wrap, bg=theme.WINDOW_DEEP)
        title_row.place(x=title_left, y=6)
        tk.Label(
            title_row,
            text="TomeLinea",
            bg=theme.WINDOW_DEEP,
        ...
        ).place(x=title_left + 3, y=58)

        tools = tk.Frame(header, bg=theme.WINDOW_DEEP)
        tools.place(relx=0.74, rely=0.14, relwidth=0.24, relheight=0.52)
        help_label = tk.Label(

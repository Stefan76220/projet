...
class PageMaitreV2(tk.Tk):
    ...
    def _build_all_screens_once(self) -> None:
        ...
        # L'Accueil passe devant immédiatement ; les bureaux sont construits derrière.
        ...
        # Premier bureau de projet préparé derrière l'Accueil.
    ...
    def show_screen(self, name: str) -> None:
        ...
        # Navigation interne au projet : immédiate, comme le ruban déjà validé.
        if previous != "accueil":
            screen.tkraise()
            if name == "centre":
        ...
        # Accès direct depuis l'Accueil : on prépare le bureau derrière l'Accueil,
        # puis ruban + bureau sont révélés ensemble.
        self.accueil_host.tkraise()
        screen.tkraise()
        ...
        def _reveal_project():
            ...
            # Une seule révélation visuelle finale.
            self.project_shell.tkraise()

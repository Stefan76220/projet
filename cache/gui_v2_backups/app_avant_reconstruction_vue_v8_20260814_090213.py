...
class PageMaitreV2(tk.Tk):
    ...
    # VUE_DU_LIVRE_DEUX_ONGLETS_DYNAMIQUES_V7_SWITCH_INSTANTANE
    def _tomelinea_open_book_views(self, initial_tab="global"):
        ...
        # ----------------------------------------------------------
        # Contrôleur de changement de vue V7.
        #
        # Aucun effet de transition :
        #   - l'ancienne vue disparaît immédiatement ;
        #   - une seule géométrie est appliquée ;
        #   - la nouvelle vue est dessinée directement à sa place.
        # ----------------------------------------------------------
        ...
        def show_tab(key, *, animate=True):
            ...
            # Cache immédiatement les deux surfaces avant changement.
            # Le nouveau mode ne sera montré qu'après la géométrie finale.
            global_host.lower()
            book_host.lower()
            ...
            # Un seul changement de taille/position Windows.
            win.geometry(
                f"{final_w}x{final_h}"
                f"+{final_x}+{final_y}"
            )
            ...
            # Redessine le shell une seule fois à la taille définitive.
            redraw_shell()

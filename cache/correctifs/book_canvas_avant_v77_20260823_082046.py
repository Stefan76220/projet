# TOMELINEA_GABARITS_FOND_GUIDE_V76
...
class BookCanvas(tk.Frame):
    ...
    def _render_gabarit_zone_inspector(self, target, width: float, height: float, info: dict, *, multi_infos=None) -> None:
        ...
        if active_band == "allowed":
            ...
            content_h = 198.0 if guide else 60.0
        ...
        if active_band == "create":
            ...
            if not guide:
                ...
                target.create_text(fly_left+11.0,content_top+52.0,text="CADRAGE AUTO",anchor="w",fill="#9FB0B3",font=(theme.FONT_UI,8,"bold"))
                icon_strip((

        ...
        def confirm_type_scope(page_type_label: str, page_count: int) -> bool:
            ...
            return bool(messagebox.askyesno(
                ...
                (
                    ...
                    "Les différences de gabarit déjà présentes sur ces pages seront remplacées. "
                    "Les modifications suivantes seront ensuite répétées sur toutes les pages de ce type."
                ),
                parent=self,
            ))

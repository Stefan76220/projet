...
# TOMELINEA_GABARITS_REGLAGES_LIVRE_V55
...
class BookCanvas(tk.Frame):
    ...
    def _render_gabarit_inspector_overlay(self, *, force: bool = False):
        ...
        exception = frame_ref != "margins"
        target.create_text(tx, y, text="CADRE DE TRAVAIL", anchor="w", fill="#A8BCC0", font=(theme.FONT_UI, 8, "bold"))
        # Le mode actif est déjà indiqué par les boutons sélectionnés ci-dessous.
        # On supprime donc le libellé à droite pour éviter la superposition
        # visuelle et le doublon d'information.
        y += 18.0
        gap = 5.0
        bw = (inner - gap) / 2.0

...
class PageMaitreV2(tk.Tk):
    ...
    def _build_maquettage(self, parent: tk.Frame) -> None:
        ...
        def render(_event=None):
            ...
            # Variante finale — fil neutre + losanges sobres.
            # Référence validée : texte noir, ligne neutre, icônes réalistes,
            # repères losange et position active indiquée sans couleur.
            ...
            for index, group in enumerate(structure_model):
                ...
                # Losange de station : blanc pour les autres, noir pour la partie active.
                ...
                # Icônes réalistes, sans disque, toutes placées au même niveau.
                photo_index = min(index, len(structure_icon_paths) - 1)
                if index == 0 or index == node_count - 1:
                    # Départ et fin ont exactement la même boîte d'affichage.
                    max_w, max_h = 62, 62
                else:
                    max_w, max_h = 68, 58
                ...
                # Tous les textes de la ligne restent noirs.
                canvas.create_text(
                    cx,
                    track_y + 27,
                    text=group["name"],

...
class Workspace:
    ...
    def show_documents(
        ...
        """
        Construit le Centre derrière l'écran courant.

        Le conteneur principal n'est plus masqué ni vidé : l'ancien écran
        reste visible jusqu'à ce que le nouveau Centre soit prêt.
        """
        ...
        try:
            ...
            self.host.rebuild("documents", build)

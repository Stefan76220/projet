...
class BookCanvas(tk.Frame):
    ...
    def _build_canvas(self):
        ...
        # Le navigateur reste centré sur le champ de vision, indépendamment
        # du bloc zoom placé à droite.
        self.h_nav = TLBookNavigator(nav_row, command=self._navigate_horizontal)
        self.h_nav.place(relx=0.5, rely=0.5, anchor="center")

        zoom_controls = tk.Frame(nav_row, bg=theme.WINDOW_DEEP)
        zoom_controls.place(relx=1.0, x=-8, rely=0.5, anchor="e")

...
class PageMaitreV2(tk.Tk):
    ...
    def _build_maquettage(self, parent: tk.Frame) -> None:
        ...
        def render(_event=None):
            ...
            # RETOUR_COMPOSITION_V2
            # Ligne de retour vers la page suivante située à gauche.
            if len(row_layouts) >= 2:
                ...
                if first_row and second_row:
                    ...
                    y1 = last_item["base_y"] - 18
                    y2 = next_item["base_y"] - 18

                    # Sortie de la dernière page à droite, descente,
                    # puis retour directement vers la première page
                    # de la ligne suivante, à gauche.
                    return_right_x = cx2 - 8
                    start_x = last_item["px2"] + 5
                    end_x = next_item["px2"] + 5

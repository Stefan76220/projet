...
class PageMaitreV2(tk.Tk):
    ...
    def _build_maquettage(self, parent: tk.Frame) -> None:
        ...
        def render(_event=None):
            ...
            # Habillage TomeLinea : médaillons éditoriaux, livres et drapeaux.
            ...
            def draw_book_icon(cx, cy, color):
                edge = self._mix(color, theme.INK, 0.24)
                tint = self._mix(color, "#FFFFFF", 0.86)
                shadow = self._mix(color, "#BDB6AD", 0.55)
                ...
                canvas.create_line(
                    ...
                    cx - 4,
                    cy - 6,
                    fill=self._mix(edge, "#FFFFFF", 0.45),
                    width=1,
                    tags="maquettage_ui",
                )
                canvas.create_line(
            ...
            def draw_flag_icon(cx, cy, color, *, finish=False):
                edge = self._mix(color, theme.INK, 0.26)
                tint = self._mix(color, "#FFFFFF", 0.72)
                pole_x = cx - 8
                ...
                if finish:
                    ...
                    squares = [
                        (pole_x + 1, cy - 9, pole_x + 7, cy - 4),
                        (pole_x + 7, cy - 4, pole_x + 13, cy + 0),
                        (pole_x + 1, cy + 0, pole_x + 7, cy + 4),
                    ]
                    ...
                    canvas.create_line(
                        ...
                        pole_x + 10,
                        cy - 5,
                        fill=self._mix("#FFFFFF", edge, 0.25),
                        width=1,
                        tags="maquettage_ui",
                    )
            ...
            for index, group in enumerate(structure_model):
                ...
                canvas.create_oval(
                    ...
                    cx + 19,
                    cy + 19,
                    fill=self._mix(color, "#FFFFFF", 0.94),
                    outline=color,
                    width=2,
                    tags="maquettage_ui",
                )
                ...
                if index == 0:
                    draw_flag_icon(cx, cy, color, finish=False)
                elif index == node_count - 1:
                    draw_flag_icon(cx, cy, color, finish=True)
                else:
                    draw_book_icon(cx, cy, color)

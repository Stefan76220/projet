...
class TomeLineaV3(tk.Tk):
    ...
    def _build_gabarits_tab(self, parent):
        ...
        # Même trait fin de délimitation qu'à droite : il marque la limite
        # de la zone OUTILS sans réintroduire un fond opaque.
        left_boundary = tk.Frame(atelier, bg=theme.BORDER, width=1)
        left_boundary.place(relx=1.0, x=-1, y=0, relheight=1.0, anchor="ne")
        left_boundary.lift()

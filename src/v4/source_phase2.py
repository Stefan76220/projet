...
def build_phase2_model(
    ...
    *,
    ...
    if unsupported:
        blockers.append(Phase2Blocker(
            code="unsupported_body_nodes",
            message="Le corps DOCX contient des blocs non pris en charge.",
            details={"nodes": unsupported},
            solution="Identifier le bloc DOCX non pris en charge puis le convertir vers un élément TomeLinea compatible avant de reprendre la composition.",
        ))
    ...
    if missing_fonts:
        blockers.append(Phase2Blocker(
            code="missing_fonts",
            message="Une ou plusieurs polices/faces requises sont absentes.",
            details={"fonts": missing_fonts},
            solution="Installer la police manquante ou l’ajouter à la bibliothèque TomeLinea, puis relancer l’analyse. Aucune substitution silencieuse ne sera faite.",
        ))

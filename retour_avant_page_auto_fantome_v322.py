...
BACKUP = Path(r"C:\Users\PC\projet\cache\correctifs\avant_page_auto_fantome_v322_20260817_213051\book_canvas.py")
BOOK = ROOT / "src" / "gui_v3" / "book_canvas.py"

shutil.copy2(BACKUP, BOOK)
py_compile.compile(str(BOOK), doraise=True)
print("RETOUR_AVANT_PAGE_AUTO_FANTOME_V322_OK")

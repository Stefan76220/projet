...
class PageMaitreV2(tk.Tk):
    ...
    def show_screen(self, name: str) -> None:
        ...
        if name == "accueil":
            ...
            # Aucun changement de géométrie : l'Accueil passe simplement
            # devant l'espace Projet déjà construit derrière lui.
            self.accueil_host.tkraise()
            return

        self._active = name

        # Le bureau demandé est levé dans l'espace Projet, puis l'ensemble
        # ruban + bureau passe devant l'Accueil.
        screen.tkraise()
        self.project_shell.tkraise()

        # Seul l'état visuel actif du ruban est rafraîchi.
        self._render_header_canvas()

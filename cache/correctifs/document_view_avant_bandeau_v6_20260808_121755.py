...
class DocumentView:
    ...
    def _create_internal_navigation_ribbon(
        ...
        V5 :
        - fond général PageMaître réellement visible dans le ruban ;
        - Visualisation et Suivi du livre restent à gauche ;
        - Accueil rejoint le parcours et se place juste avant Centre ;
        - icônes actuelles conservées provisoirement avant création
          du jeu d'icônes personnalisé définitif.
        """
        ribbon = ctk.CTkFrame(
            parent,
            height=96,
        ...
        ribbon.grid_columnconfigure(0, weight=0, minsize=235)
        ribbon.grid_columnconfigure(1, weight=1)
        ribbon.grid_columnconfigure(2, weight=0, minsize=76)
        ribbon.grid_rowconfigure(0, weight=1)

        # ======================================================
        # Fond PageMaître visible + décor éditorial intégré
        # ======================================================
        ...
        ribbon._navigation_background_image = None
        ribbon._navigation_background_size = (0, 0)
        ...
        def build_background(width: int, height: int):
            ...
            if background_path.is_file():
                try:
                    ...
                    # Recadrage "cover" pour remplir tout le ruban.
                    ...
                    # Le fond reste léger mais réellement perceptible.
            ...
            # Frise éditoriale rectiligne, discrète.
            y = height - 9
            pale = (75, 101, 125, 54)
            blue = (117, 182, 219, 86)
            teal = (130, 183, 161, 84)
            lilac = (169, 151, 201, 78)
            coral = (223, 128, 107, 76)
            ...
            for x in (30, width // 2, max(30, width - 30)):
                draw.line(
                    (x - 7, y, x + 7, y),
                    fill=blue,
                    width=1,
            ...
            # Petit livre ouvert au centre-bas.
            cx = width // 2
            by = y - 1
            draw.line(
                (
        ...
        def redraw_background(_event=None) -> None:
            try:
                ...
                if ribbon._navigation_background_size == (width, height):
                    return
                ...
                ribbon._navigation_background_image = ctk_image
                ribbon._navigation_background_size = (width, height)
                background_label.configure(image=ctk_image)
        ...
        def make_icon(
            ...
            if kind == "home":
                ...
                # Icône distincte de l'Accueil : cible / centre de pilotage.
                draw.ellipse(
                    (p(5), p(5), p(23), p(23)),
                    outline=stroke,
                    width=width,

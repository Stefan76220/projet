...
class BookCanvas(tk.Frame):
    ...
    def _gabarit_owner_is_visible(self) -> bool:
        """V97 — un Toplevel d'outils ne doit jamais survivre à son bureau.

        Les palettes Gabarits sont des fenêtres détachées sous Windows ; masquer
        le Frame principal ne les masque donc pas automatiquement. On vérifie
        explicitement que BookCanvas ET son Canvas sont réellement affichés.
        """
        try:

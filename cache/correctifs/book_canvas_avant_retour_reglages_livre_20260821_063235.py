...
class BookCanvas(tk.Frame):
    ...
    def _render_gabarit_inspector_overlay(self, *, force: bool = False):
        ...
        Sans sélection, les réglages généraux du livre ne sont pas répétés ici :
        ils sont établis avant l'entrée dans le bureau Gabarits. Le panneau ne
        montre donc que l'identité de la page, son cadre de travail et la création.
        ...
        # 2 — Cadre : Marges par défaut, Page uniquement pour l'exception rare.
        ...
        # 3 — Première action de construction. Rien d'autre avant sélection.

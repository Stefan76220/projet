...
class PageMaitreV2(tk.Tk):
    ...
    def _render_header_canvas(self, _event=None) -> None:
        ...
        relief_high = self._mix(theme.WINDOW, "#FFFFFF", 0.22)
        relief = self._mix(theme.WINDOW, "#000000", 0.34)
        canvas.create_line(
            0, height - 5,
            width, height - 5,
            fill=relief_high,
    ...
    def _build_visualisation_vierge(self, parent: tk.Frame) -> None:
        ...
        def draw_global_panel(_event=None):
            ...
            global_panel.create_line(
                14, h - 4, w - 22, h - 4,
                fill=self._mix(PANEL, "#FFFFFF", 0.24),
                width=1,
                tags=("panel_decor",),
            )
            global_panel.create_line(
                12, h - 2, w - 20, h - 2,
                fill=self._mix(PANEL, "#000000", 0.34),
                width=4,
                tags=("panel_decor",),
            )
...
# REBORD_RELIEF_VISIBLE_GLOBAL_V9B
    ...
    def _card(
        ...
        *,
        ...
        tk.Frame(
            card,
            bg=self._mix(theme.PANEL, "#000000", 0.34),
            height=4,
        ).pack(side="bottom", fill="x", padx=10, pady=(0, 1))
        tk.Frame(
            card,
            bg=self._mix(theme.PANEL, "#FFFFFF", 0.22),
            height=1,
    ...
    def _build_centre(self, parent: tk.Frame) -> None:
        ...
        def render(_event=None):
            ...
            canvas.create_line(
                left + 16, book_y2 - 4,
                right - 24, book_y2 - 4,
                fill=self._mix(theme.PANEL, "#FFFFFF", 0.24),
                width=1,
            )
            canvas.create_line(
                left + 14, book_y2 - 2,
                right - 22, book_y2 - 2,
                fill=self._mix(theme.PANEL, "#000000", 0.34),
                width=4,
            )
            canvas.create_rectangle(

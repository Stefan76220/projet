...
class PageMaitreV2(tk.Tk):
    ...
    # VUE_DU_LIVRE_DEUX_ONGLETS_DYNAMIQUES_V5_SUPPORT_PHOTOREALISTE
    def _tomelinea_open_book_views(self, initial_tab="global"):
        ...
        def animate_window_to(target_size):
            # Tk/Windows n'aime pas les dizaines de redimensionnements par
            # seconde. On privilégie une cadence plus réaliste (environ 40 i/s)
            # et une courbe smootherstep : moins d'images, mais plus régulières.
            ...
            def frame():
                ...
                # smootherstep : départ et arrivée sans cassure.
                eased = (
                    t * t * t
                    * (
                        t * (t * 6.0 - 15.0)
                ...
                if geometry != last_geometry[0]:
                    ...
                    # Laisse Windows appliquer chaque étape avant la suivante.
                    try:
                        win.update_idletasks()
                    except Exception:
                        pass

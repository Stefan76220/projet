...
class BookCanvas(tk.Frame):
    ...
    def _build_canvas(self):
        ...
        # Gabarits : les outils ne vivent plus dans C. Cette bande verticale
        # est un frère du Canvas et se superpose uniquement à la réserve gauche.
        # Le moteur de rendu exclut explicitement cette largeur de la surface page.
        self.gabarit_tools_host = tk.Frame(
            viewer, bg="#102633", bd=0, highlightthickness=0,
        )
    ...
    def set_work_mode(self, mode: str):
        ...
        tools_host = getattr(self, "gabarit_tools_host", None)
        if tools_host is not None:
            try:
                if mode == "gabarits":
                    tools_host.place(

...
class PageMaitreV2(tk.Tk):
    ...
    def _build_maquettage(self, parent: tk.Frame) -> None:
        ...
        def render(_event=None):
            ...
            # Ligne de retour vers la rangée suivante.
            ...
            # Légende visuelle non interactive.
            legend_y = min(
                pages_bottom - 10,
                pages_top + 2 * (row_height + row_gap) - 2,
            )
            legend_items = (
                ("Grande : tête de partie", "#F0EAF7"),
                ("Moyenne : page courante", "#F3EFE7"),
                ("Petite : page auto", "#EDF2F6"),
            )
            legend_x = cx1

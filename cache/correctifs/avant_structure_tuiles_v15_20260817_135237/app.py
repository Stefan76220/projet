...
class TomeLineaV3(tk.Tk):
    ...
    def _build_structure_tab(self, parent):
        """Structure V14 RESET : contenu C volontairement vide avant nouvelle conception."""
        parent.grid_rowconfigure(0, weight=1)
        parent.grid_columnconfigure(0, weight=1)

        # On conserve uniquement la surface de l'onglet Structure.
        # Aucun catalogue, aucune brique, aucune règle et aucune commande
        # ne sont dessinés ici : la prochaine conception repart d'une base propre.
        self._structure_reset_surface = tk.Frame(parent, bg=theme.PANEL)
        self._structure_reset_surface.grid(row=0, column=0, sticky="nsew")

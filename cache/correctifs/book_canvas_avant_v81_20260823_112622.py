...
class BookCanvas(tk.Frame):
    ...
    GABARIT_INSPECTOR_DEFAULT_BLOCK_ORDER = (
        # V80 — Fond guide est un choix de préparation : il reste toujours
        # en tête du rail, avant toute création ou organisation de zones.
        "guide", "create", "allowed", "snap", "organize",

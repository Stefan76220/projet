...
def _headers_footers(
    ...
    for rel in relationships.values():
        ...
        if root is None:
            continue
        text = "\n".join(_paragraph_plain_text(p) for p in root.findall(".//w:p", NS)).strip()
...
def analyze_docx_phase1(path: str | Path) -> DocxPhase1Result:
    ...
    with zipfile.ZipFile(source) as archive:
        ...
        headers_footers = _headers_footers(archive, relationships)
        ...
        model = {
            ...
            "future_editorial_support": {
                ...
                "captured_for_later": [
                    ...
                    "headers_footers_notes_comments",
                    "bookmarks_hyperlinks_content_controls",
                    "tracked_changes",
                    "section_format_margins_and_columns",
                    "font_requirements_and_availability",
                ],
            },
            "warnings": [],
        }

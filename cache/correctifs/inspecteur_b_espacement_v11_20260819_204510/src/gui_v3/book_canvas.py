...
class BookCanvas(tk.Frame):
    ...
    def _render_gabarit_workspace(self, viewport_w: float, viewport_h: float) -> None:
        ...
        def section_label(y: float, text: str) -> float:
            ...
            # Respiration volontaire : l'inspecteur utilise toute la hauteur de B.
            return y + 21.0
        ...
        self.canvas.create_oval(tx + 10, y + 9.5, tx + 22, y + 21.5, fill=status_color, outline="")
        ...
        self.canvas.create_text(tx + 10, y + 11, text="Format fini", anchor="w", fill="#F0F2F0", font=(theme.FONT_UI, 9, "bold"))
        self.canvas.create_text(
            tx + 10, y + 27,
        ...
        self.canvas.create_text(tx + 10, y + 11, text="Marges", anchor="w", fill="#F0F2F0", font=(theme.FONT_UI, 9, "bold"))
        self.canvas.create_text(tx + 10, y + 27, text=compact_values(margins, ("top", "bottom", "inside", "outside"), ("H", "B", "I", "E")), anchor="w", fill="#B8C6C3", font=(theme.FONT_UI, 8))
        self.canvas.create_text(inner_right - 9, y + book_control_h / 2.0, text="›", anchor="e", fill="#A6B7BA", font=(theme.FONT_UI, 11, "bold"))
        y += 45.0
        control_box("edit_bleed", y, book_control_h)
        self.canvas.create_text(tx + 10, y + 11, text="Fond perdu", anchor="w", fill="#F0F2F0", font=(theme.FONT_UI, 9, "bold"))
        self.canvas.create_text(tx + 10, y + 27, text=compact_values(bleed, ("top", "bottom", "left", "right"), ("H", "B", "G", "D")), anchor="w", fill="#D1AAAA", font=(theme.FONT_UI, 8))
        self.canvas.create_text(inner_right - 9, y + book_control_h / 2.0, text="›", anchor="e", fill="#A6B7BA", font=(theme.FONT_UI, 11, "bold"))
        y += book_control_h

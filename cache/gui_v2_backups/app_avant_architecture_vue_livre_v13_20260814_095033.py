...
class PageMaitreV2(tk.Tk):
    ...
    # VUE_DU_LIVRE_DEUX_ONGLETS_DYNAMIQUES_V12_SWITCH_DIRECT_TESTE
    def _tomelinea_open_book_views(self, initial_tab="global"):
        ...
        # ----------------------------------------------------------
        # Changement de vue V12 — simple et synchrone.
        #
        # Base volontairement issue de la V10 qui avait des clics stables.
        # Aucun verrou Win32, alpha, withdraw, timer ou animation.
        # Un clic = un état + un tkraise + une seule geometry().
        # ----------------------------------------------------------
        switch_state = {
            "active": False,
        }
        ...
        def show_tab(key, *, animate=True):
            ...
            try:
                ...
                # Une seule modification de la fenêtre native.
                ...
                # Le clic est déjà pris en compte avant le recalcul visuel.
                # On redessine ensuite uniquement à la dimension finale.
                win.update_idletasks()
                redraw_shell()
                draw_title_line()
